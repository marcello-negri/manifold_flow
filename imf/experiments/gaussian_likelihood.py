...
def mh_sampler(burnin=10000, chains=1000, iterations=20000, subsample=2000, dim=10, dtype = torch.float64, device="cuda"):
...
def main():
    ...
    # load data
    sigma_true = 0.09
    X_np, y_np = generate_regression_simplex(n=20, d=10, sigma=sigma_true)
